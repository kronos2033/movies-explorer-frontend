...
function AboutMe() {
  return (
    <section id="about-me" className="about-me section_type_narrow">
      ...
      <article className="about-me__info">
        <div className="about-me__container">
          ...
          <p className="about-me__text">
            ...
            технический университет по специальности информационная
            безопасность. После окончания учёбы устроился работать и параллельно
            начал изучать фронт-энд разработку. Углубляю свои знания, а так же
            развиваю другие области жизни.
          </p>
          <ul className="about-me__links">
            ...
            <li className="about-me__link">
              <a className="about-me__social" href="https://t.me/randomgodmod">
                Telegram
              </a>
            </li>
          </ul>
