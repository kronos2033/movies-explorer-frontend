...
function AboutProject() {
  return (
    <section id='about' className='about section section_type_narrow'>
      <h2 className='about__title'>О проекте</h2>
      <div className='about__diplom-container'>
        <article className='about__diplom'>
          <h3 className='about__diplom-title'>
            Дипломный проект включал 5 этапов
          </h3>
          <p className='about__diplom-text'>
      ...
      <div className='about__duration'>
        <p className='about__first-week'>1 неделя</p>
